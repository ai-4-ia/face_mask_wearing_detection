...
from detect_mask_video import Load_WebCam
# Setting custom Page Title and Icon with changed layout and sidebar state
st.set_page_config(page_title='Face Mask Detection using Resnet50/MobileNet_v2',
...
RGB_img = Image.open('./images/out.jpg')


def mask_image(module):
    global RGB_img
...
def mask_detection():
    ...
    if choice == 'Image':
        ...
        image_file = st.file_uploader(
            "", type=['png', 'jpeg', 'jpg'],  accept_multiple_files=False)  # upload image
    ...
    if choice == 'Webcam':
        ...
        if st.sidebar.button('Start tracking'):
            Load_WebCam(faceNet, maskNet)
        st.sidebar.markdown(
            '<h3 style="text-align: center; color: red; font-style: italic; ">please press the Q(quit) key to turn off the webcam!</h3>', unsafe_allow_html=True)
